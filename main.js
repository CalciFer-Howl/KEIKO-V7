...
async function gandu() {
  try {
    ...
    const lawde = Buffer.from(`VGhpcyBJcyBUaGUgQ2hlYXBlc3QgQ29weSBPZiBBbWVlbkludCBCb3RzLiBUaGUgT3JpZ2luYWwgQm90IElzIEtlaWtvIFY1LiBKdXN0IENoZWNrIHRoZSBSZXBvIGh0dHBzOi8vZ2l0aHViLmNvbS9BbWVlblJlcG8vS0VJS08tVjU=`, 'base64').toString();
    const endi = Buffer.from(`RXZlcnkgVGhpbmcgSXMgT2tleS4gVGhhbmsgWW91IEZvciBVc2luZyBBbWVlbkludCBCb3QgS2Vpa28tVjU=`, 'base64').toString();
...
if (pairingCode && !conn.authState.creds.registered) {
  ...
  setTimeout(async () => {
    ...
    const pairingCode = chalk.bold.greenBright('Your Pairing Code:') + ' ' + chalk.bgGreenBright(chalk.black(code));
...
global.reloadHandler = async function (restatConn) {
  ...
  if (currentDateTime >= messageDateTime) {} else {}
